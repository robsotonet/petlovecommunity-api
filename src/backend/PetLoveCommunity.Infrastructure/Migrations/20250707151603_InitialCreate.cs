        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryPhotoUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    AdoptedById = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pets_Users_AdoptedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventRsvps", x => new { x.UserId, x.EventId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPetFavorites", x => new { x.UserId, x.PetId });
                    table.ForeignKey(
                        name: "FK_UserPetFavorites_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPetFavorites_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorReviews_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventPhotos_IsPrimary",
                table: "EventPhotos",
                column: "IsPrimary");

            migrationBuilder.CreateIndex(
                name: "IX_EventRsvps_CreatedAt",
                table: "EventRsvps",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRsvps_Status",
                table: "EventRsvps",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_EventRsvps_UserId_EventId",
                table: "EventRsvps",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetPhotos_DisplayOrder",
                table: "PetPhotos",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_PetPhotos_IsPrimary",
                table: "PetPhotos",
                column: "IsPrimary");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPetFavorites_PetId",
                table: "UserPetFavorites",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPetFavorites_UserId_PetId",
                table: "UserPetFavorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorPhotos_VendorId",
                table: "VendorPhotos",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorReviews_BookingId",
                table: "VendorReviews",
                column: "BookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VendorReviews_CreatedAt",
                table: "VendorReviews",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorServices_Price",
                table: "VendorServices",
                column: "Price");

            migrationBuilder.CreateIndex(
                name: "IX_VendorServices_Status",
                table: "VendorServices",
                column: "Status");
